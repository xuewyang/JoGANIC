...
@Decoder.register('decoder_tell_wiki')
class DecoderTellWiki(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            DynamicConvWIKIDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                        decoder_conv_type, weight_softmax, decoder_attention_heads,
...
@DecoderLayer.register('dynamic_conv_wiki')
class DynamicConvWIKIDecoderLayer(DecoderLayer):
