...
from TGNC.models.decoder_5h import Decoder
from TGNC.models.resnet import resnet152


@Model.register("model_5h")
class FHModel(Model):
    def __init__(self,
                 vocab: Vocabulary,
                 decoder: Decoder,
        ...
        self.textmodel.register_classification_head('template_prediction_task', num_classes=5)
    ...
    def generate(self,  # type: ignore
                 ...
                 label: torch.Tensor,
                 ent: torch.Tensor,
                 metadata: List[Dict[str, Any]]) -> Dict[str, list]:
        B = image.shape[0]
    ...
    def _forward(self,
        ...
        template_logits = self.textmodel.predict('template_prediction_task', article_ids, return_logits=True)
