...
@Decoder.register('decoder_5h')
class DynamicConvFHDecoder(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            DynamicConvFHDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                      decoder_conv_type, weight_softmax, decoder_attention_heads,
...
@DecoderLayer.register('dynamic_conv_fh')
class DynamicConvFHDecoderLayer(DecoderLayer):
