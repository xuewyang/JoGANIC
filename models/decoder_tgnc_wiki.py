...
from TGNC.modules import (AdaptiveSoftmax, DynamicConv1dTBC, GehringLinear,
                          LightweightConv1dTBC, MultiHeadAttention)
from TGNC.modules.token_embedders import AdaptiveEmbedding
from TGNC.utils import eval_str_list, fill_with_neg_inf, softmax
from TGNC.models.decoder_base import Decoder, DecoderLayer


@Decoder.register('decoder_tgnc_wiki')
class DecoderTGNCWiki(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            DynamicConvTGNCWikiDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                            decoder_conv_type, weight_softmax, decoder_attention_heads,
...
@DecoderLayer.register('dynamic_conv_tgnc_wiki')
class DynamicConvTGNCWikiDecoderLayer(DecoderLayer):
    def __init__(self, decoder_embed_dim, decoder_conv_dim, decoder_glu,
        ...
        entity_embed_size = 300
        self.context_attns['entity'] = MultiHeadAttention(
            self.embed_dim, decoder_attention_heads, kdim=entity_embed_size, vdim=entity_embed_size,
            dropout=attention_dropout)
