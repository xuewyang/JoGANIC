...
@TokenIndexer.register("roberta_ms")
class RobertaMSTokenIndexer(TokenIndexer[int]):
    def __init__(self,
    ...
    def tokens_to_indices(self,
        ...
        if len(indices) <= self._max_len:
            indices_1 = indices
            indices_2 = [0, 2]
        else:
            indices_1 = indices[:self._max_len-1] + [2]
            indices_2 = [0] + indices[self._max_len-self.span-1: self._max_len * 2 - self.span - 3] + [2]
            if indices_2[-2] == 2:
                indices_2 = indices_2[:-1]

        return {
            index_name + '_1': indices_1,
            index_name + '_2': indices_2,
        }
