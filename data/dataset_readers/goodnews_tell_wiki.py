...
@DatasetReader.register('goodnews_tell_wiki')
class GoodNewsTellWikiReader(DatasetReader):
    def __init__(self,
                 tokenizer: Tokenizer,
    ...
    def _read(self, split: str):
        ...
        for sample_id in ids:
            ...
            yield self.article_to_instance(article, image, caption, image_path, ent)

    def article_to_instance(self, article, image, caption, image_path, ent) -> Instance:
